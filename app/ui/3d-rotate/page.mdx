...
<Tabs tabs={["Demo", "Code"]}>
  <Tab title="Demo">
    <div className="w-full flex justify-center sm:py-4 md:py-10">
      <ThreeDRotate>
        <div className="flex justify-center items-center sm:w-80 sm:h-80 lg:w-96 lg:h-96 border dark:border-accent-white/50 border-accent-dark/50 rounded">
...
<Tab title="Code">
```tsx
import { ThreeDRotate } from "@/components/ui/3d-effects"; // your file path
