...
import { Window } from "@/components/ui/effects";
import { Tabs, Tab } from "@/components/ui/general";

export const metadata = {
  title: "Window | EZ UI",
  description: "The Window component simulates the appearance of browser for visually enhancing application UIs."
};

# Window
The `Window` component simulates the appearance of browser for visually enhancing application UIs.

## Example

<ExampleBox className="justify-evenly lg:flex-row flex-col gap-16 md:px-10 px-4 font-playwrite-gbs">
  <Window>
    <div className="w-60 h-28 bg-accent-300 rounded-b p-2 text-white">
      Mac Dark
    </div>
  </Window>
  <Window type="mac-light">
    <div className="w-60 h-28 bg-accent-white rounded-b p-2 text-accent-300">
      Mac Light
    </div>
  </Window>
  <Window type="windows-dark" className="py-2">
    <div className="w-60 h-28 bg-accent-300 rounded-b p-2 text-white">
      Windows Dark
    </div>
  </Window>
...
<Tabs tabs={["Demo", "Code"]}>
    ...
    <div className="w-full flex justify-center py-10">
      <Window type="mac-dark">
        <div className="w-60 h-28 bg-accent-300 rounded-b text-white p-4 flex gap-3">
          ...
          <p className="text-sm">Build interactive, dynamic, and fast React applications</p>
        </div>
      </Window>
    </div>
  </Tab>
  <Tab title="Code">
    ```tsx
    import { Window } from "@/components/ui/effects";  // your file path
...
|---------------|--------------------------|--------------|-------------|---------------------------------------------------------------------------------|
| `className`   | `string`                | No           | `undefined` | Adds custom classes to the window(bar) for additional styling.                   |
| `children`    | `React.ReactNode`       | No           | `undefined` | Content to display inside the window.                                            |
| `type`        | `"none"`, `"windows-dark"`, `"windows-light"`, `"mac-dark"`, `"mac-light"` | No | `"mac-dark"` | Defines the style of the window header.|
