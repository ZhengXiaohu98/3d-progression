...
import { View, PointLight } from "@/components/ui/effects";
...
<ExampleBox className="justify-evenly md:flex-row flex-col gap-10 md:px-10 px-4">
  <View>
    <Image src="/images/project/3d-book-gallery/img6.jpg" width={489} height={430} className="w-fit max-h-screen rounded-md"/>
  </View>
</ExampleBox>
