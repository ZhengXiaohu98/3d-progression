...
<ExampleBox className="justify-evenly md:flex-row flex-col gap-10 ">
  <WorldMap 
    className="lg:w-[800px] md:w-[600px] w-[300px] dark:!fill-white !fill-accent-300" 
    points={[
...
<Tabs tabs={["Demo", "Code"]}>
  <Tab title="Demo">
    <div className="w-full flex justify-center py-10">
      <WorldMap 
        className="lg:w-[800px] md:w-[600px] w-[300px] dark:!fill-[#ecfeff] !fill-[#155e75]" 
        points={[
