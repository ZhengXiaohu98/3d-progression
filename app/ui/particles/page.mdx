...
<ExampleBox>
  <Particles count={100} colors={["#c084fc", "#e879f9", "#f472b6", "#fb7185", "#818cf8", "#60a5fa", "#fb923c"]} speed={1} size={[1, 2.5]} className="h-[300px] w-[300px] rounded border dark:border-accent-300 border-accent-ccc"/>
</ExampleBox>
...
| `colors`      | `string[]`               | No           | `["#ff7f50", "#1e90ff", "#32cd32", "#ffd700"]` | Array of colors to randomize particles' colors.                                  |
