...
<ExampleBox className="lg:flex-row flex-col justify-evenly gap-10">
  <DualCompare className="md:w-[400px] md:h-[400px] w-[280px] h-[280px] shadow-2xl dark:shadow-gray-dark" autoPlay={false}>
    <div className="w-full h-full">
      <Image src="/images/project/3d-book-gallery/img9.jpg" width={1800} height={949} className="w-full h-full rounded-md" />
    </div>
    <div className="w-full h-full">
      <Image src="/images/project/3d-book-gallery/img7.jpg" width={1800} height={949} className="w-full h-full rounded-md" />
    </div>
  </DualCompare>
