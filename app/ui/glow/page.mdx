...
<ExampleBox>
  <div className="w-full flex flex-col lg:flex-row gap-10 md:gap-16 items-center justify-around">
    <Glow className="rounded-xl">
      <div className="w-[300px] sm:p-4 lg:p-6 rounded-xl">
        <Image src="/images/project/3d-book-gallery/img2.jpg" width={1800} height={949} className="w-full h-fit rounded-md"/>
        <p className="sm:mt-3 md:mt-4 font-bold text-accent-dark dark:text-accent-white sm:text-lg md:text-xl">Glow Effect</p>
        <p className="sm:mt-1 md:mt-2 font-semibold text-accent-300 dark:text-accent-900 sm:text-xs md:text-sm">You can pass an array of colors to animate the glow effect!</p>
      </div>
    </Glow>
