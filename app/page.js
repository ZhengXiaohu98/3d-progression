    ...
    <>
          ...
          <div className="flex justify-between lg:w-[1024px]">
            <div className="flex flex-col sm:gap-3 md:gap-4">
              <h1 className="intro-text font-semibold md:text-3xl md:leading-relaxed sm:text-2xl sm:leading-normal tracking-wider max-w-[500px] bg-clip-text text-transparent bg-gradient-to-b dark:from-white dark:to-white/80 from-black to-black/80">
                ...
                <span className="dark:from-[#c2410c77] dark:via-[#7e22c755] dark:to-[#c2410c77] from-[#c2410c] via-[#7e22c7] to-[#c2410c] bg-clip-text text-transparent bg-gradient-to-l gradient-text bg-[length:200%_100%]">{"creative engaging 3D"}</span> {"websites."}
              </h1>
              <p className="intro-text text-[#737373] dark:text-[#999] tracking-wide text-sm">{"WuXi • UTC/GMT +8"}</p>
            </div>
            <div className="sm:hidden md:flex flex-col items-center gap-10">
              <div id="logo" className="relative">
                ...
                <div className="absolute inset-0 -z-10 bg-gradient-to-bl from-[#c2410c] to-[#7e22c7] opacity-50 blur-xl" />
              </div>
      ...
      <section className="relative">
        <div className="container flex flex-col items-center sm:pt-12 md:pt-16 lg:pt-24">
          ...
          <div className="flex justify-between gap-6 lg:w-[1024px] md:mt-10">
            <ul className="flex flex-col gap-8 w-1/2">
              {experience.map((exp) => (
                <li key={exp.name} className="p-4 w-full flex flex-col gap-1.5 rounded-xl dark:shadow-inner dark:shadow-white/[0.05] shadow-md shadow-black/[0.05]">
                  <div className="flex items-center gap-2 dark:text-[#ededed] text-[#0a0a0a]">
                  ...
                  <p className="text-xl font-bold dark:text-[#ededed] text-[#0a0a0a]">{exp.company}</p>
                  <p className="dark:text-[#999] text-[#737373]">{exp.description}</p>
                </li>
              ))}
            </ul>
            <div className="flex flex-col gap-6 w-1/2 h-full">
              <div className="p-4 w-full h-full flex flex-col gap-4 rounded-xl dark:shadow-inner dark:shadow-white/[0.05] shadow-md shadow-black/[0.05]">

              </div>
              <div className="p-4 w-full flex flex-col gap-4 rounded-xl dark:shadow-inner dark:shadow-white/[0.05] shadow-md shadow-black/[0.05]">
                <div className="flex items-center gap-2 text-sm dark:text-[#ededed] text-[#0a0a0a]">
                ...
                <div className="flex flex-col gap-4 dark:text-[#ededed] text-[#0a0a0a]">
