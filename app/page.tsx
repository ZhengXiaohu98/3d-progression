...
const convertToSpanText = (originalText: string, breakWord = "") => {
  return (
    <>
          ...
          <div className="flex justify-between lg:w-[1024px]">
            ...
            <div className="sm:hidden md:flex flex-col items-center gap-10">
              ...
              <div className="md:scale-100 sm:scale-75 text-accent-dark dark:text-accent-white">
                ...
                <svg id="pen" className="w-8 h-8 dark:text-white rotate-[115deg]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                  <path strokeWidth="1" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M10.779 17.779 4.36 19.918 6.5 13.5m4.279 4.279 8.364-8.643a3.027 3.027 0 0 0-2.14-5.165 3.03 3.03 0 0 0-2.14.886L6.5 13.5m4.279 4.279L6.499 13.5m2.14 2.14 6.213-6.504M12.75 7.04 17 11.28" />
                </svg>
              </div>
            </div>
          </div>
          ...
          <div className="flex lg:flex-row sm:flex-col transition-all justify-between gap-6 lg:w-[1024px] md:w-[500px] sm:w-full md:mt-10 sm:mt-6">
            ...
            <ul className="flex flex-col sm:gap-4 md:gap-8 flex-1 select-none">
              {experience.map((exp: Experience) => (
                <li key={exp.company} className="p-4 w-full flex flex-col gap-1.5 rounded-xl dark:shadow-inner dark:shadow-white/[0.05] shadow-md shadow-black/[0.05]">
                  <div className="flex items-center gap-2 dark:text-accent-white text-accent-300">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className="w-4 h-4">
                      <g clipPath="url(#clip0_429_11075)">
                        <path d="M5.63606 18.3639C9.15077 21.8786 14.8493 21.8786 18.364 18.3639C21.8787 14.8492 21.8787 9.1507 18.364 5.63598C14.8493 2.12126 9.15077 2.12126 5.63606 5.63598C3.87757 7.39447 2.99889 9.6996 3.00002 12.0044L3 13.9999" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M1 11.9999L3 13.9999L5 11.9999" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M11 7.99994L11 12.9999L16 12.9999" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                      </g>
                      <defs>
                  ...
                  <p className="sm:text-lg md:text-xl font-bold dark:text-accent-white text-accent-300">{exp.company}</p>
                  <p className="dark:text-accent-900 text-smoke-base md:text-base sm:text-sm tracking-wide">{exp.description}</p>
                </li>
              ))}
            </ul>
            {/* right */}
              ...
              <div className="relative p-4 grow flex flex-col gap-4 rounded-xl dark:shadow-inner dark:shadow-white/[0.05] shadow-md shadow-black/[0.05] overflow-hidden">
                ...
                <ul className="flex flex-col gap-2 dark:text-accent-white text-accent-300 text-base">
                  <li className="flex gap-2 items-center">
                    <svg className="w-4 h-4 -mt-0.5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 512 462.799">
              ...
              <div className="h-[164px] p-4 flex flex-col gap-4 rounded-xl dark:shadow-inner dark:shadow-white/[0.05] shadow-md shadow-black/[0.05]">
                ...
                <div className="flex flex-col gap-4 dark:text-accent-white text-accent-300 ">
                  <Marquee speed={30} pauseOnHover={true} className="w-full">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 mx-3" viewBox="-1 0 20 20" >
                      <title>html</title>
                    ...
                    <svg className="w-10 h-10 mx-3" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512">
                      <title>css</title>
                    ...
                    <svg className="w-10 h-10 mx-3" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 312.553 312.553">
                      <title>js</title>
                    ...
                    <svg className="w-10 h-10 mx-3" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                      <title>react</title>
                    ...
                    <svg className="w-10 h-10 mx-3" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
                      <title>Vue.js</title>
                  ...
                  <Marquee direction="right" speed={30} pauseOnHover={true}>
                    <svg className="w-10 h-10 mx-3" fill="none" strokeLinecap="square" strokeMiterlimit="10" version="1.1" viewBox="0 0 226.77 226.77" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className="w-10 h-10 mx-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                      <title>Figma</title>
                    ...
                    <svg className="w-10 h-10 mx-3" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32">
                      <title>mysql</title>
                    ...
                    <svg className="w-10 h-10 mx-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                      <title>python</title>
                      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
