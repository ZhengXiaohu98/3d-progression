...
const recentBlogs = [blogData[NUM_OF_BLOGS - 3], blogData[NUM_OF_BLOGS - 2], blogData[NUM_OF_BLOGS - 1]];
        ...
        <div className="container flex flex-col items-center sm:pt-16 lg:pt-24">
          <div className="w-full hidden md:flex flex-col justify-center items-center">
            <Book className="lg:w-[1000px] lg:h-[666px] md:w-[680px] md:h-[510px]" pageColor="transparent">
              ...
              <div className="h-full w-full dark:bg-accent-dark bg-white flex flex-col justify-center items-center border rounded-l-lg px-4 py-8 lg:px-10 dark:border-accent-300 border-accent-ccc">
                <h2 className="text-xl md:text-2xl tracking-wider text-center font-bold text-accent-dark dark:text-accent-white mb-3 lg:mb-6">About me</h2>
                <div className="w-full flex flex-col gap-4 lg:gap-10">
                  <div className="relative p-4 grow flex flex-col gap-4 rounded-xl overflow-hidden">
                  ...
                  <div className="h-[164px] p-4 flex flex-col gap-4">
                    <div className="flex items-center gap-2 text-sm dark:text-accent-white text-accent-300">
              ...
              {/* Page 2 - exprience */}
              <div className="h-full w-full dark:bg-accent-dark bg-white border-y border-r rounded-r-lg flex justify-center items-center px-2 lg:px-10 py-4 dark:border-accent-300  border-accent-ccc">
                <ul className="flex flex-col gap-2 lg:gap-5 w-full ">
                  {experience.map((exp: Experience) => (
                    <li key={exp.company} className="p-4 w-full flex flex-col gap-1.5">
                      <div className="flex items-center gap-2 dark:text-accent-white text-accent-300">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className="w-4 h-4 -mt-px lg:mt-0">
                      ...
                      <p className="lg:text-lg text-sm font-bold dark:text-accent-white text-accent-300">{exp.company}</p>
                      <p className="dark:text-accent-900 text-smoke-base lg:text-base text-xs tracking-wide">{exp.description}</p>
                    </li>
                  ))}
                </ul>
              </div>
              {/* Page 3 - recent article */}
              <div className="h-full w-full dark:bg-accent-dark bg-white border-y border-l rounded-l-lg flex flex-col justify-center items-center px-10 dark:border-accent-300  border-accent-ccc">
                <h2 className="text-xl md:text-2xl tracking-wider text-center font-bold text-accent-dark dark:text-accent-white mb-4 lg:mb-8">Recent blogs</h2>
                <div className="w-full flex flex-col items-center gap-10">
                  <ul className="flex flex-col gap-3 lg:gap-5">
                    {
                      recentBlogs.map((blog, idx) => (
                        <Link key={idx} href={blog.url as string}>
                          <li className="flex flex-col gap-2 relative group/blog w-fit">
                            <p className="text-base lg:text-lg underline lg:no-underline underline-offset-2 decoration-pink-base/60 text-center">{blog.title}</p>
                            <div className="lg:block hidden w-full h-px bg-pink-base/50 scale-x-0 group-hover/blog:scale-x-100 group-hover/blog:origin-left origin-right transition duration-500 ease-in-out" />
                          </li>
                        </Link>
                      ))
                    }
          ...
          <div className="w-full md:hidden flex flex-col justify-center items-center">
            <h2 className="text-2xl tracking-wider text-center font-bold text-accent-dark dark:text-accent-white mb-3">About</h2>
            <div className="w-full flex flex-col gap-4 lg:gap-10">
              <div className="relative p-4 grow flex flex-col gap-4 rounded-xl overflow-hidden">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-full h-full absolute left-10 top-0 pointer-events-none" viewBox="0 0 640 800">
                  <circle className="info-circle" r="24.5" cx="157" cy="39" strokeWidth="2" stroke="#c2410c" fill="none" opacity="0.33"></circle>
            ...
            <h2 className="text-2xl tracking-wider text-center font-bold text-accent-dark dark:text-accent-white mt-12 mb-5">Recent blogs</h2>
            <div className="w-full flex flex-col items-center gap-4">
              <ul className="flex flex-col gap-3">
                {
                  recentBlogs.map((blog, idx) => (
                    <Link key={idx} href={blog.url as string}>
                      <li className="flex flex-col gap-2 relative group/blog w-fit">
                        <p className="text-sm underline lg:no-underline underline-offset-2 decoration-pink-base/60 ">{blog.title}</p>
                      </li>
                    </Link>
                  ))
                }
              ...
              <Link href="/blog">
                <div className="w-fit lg:mt-10 mt-6 text-sm px-4 py-2 rounded-lg border dark:border-accent-300 border-accent-ccc transition duration-150 relative overflow-hidden dark:hover:bg-gray-dark/50 hover:bg-accent-white/50">
                  Read all
                </div>
              </Link>
            </div>
