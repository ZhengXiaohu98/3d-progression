...
const Section = (props) => {
  return (
    <section
      className={`h-screen flex flex-col justify-center p-10 sm:items-center ${props.right ? "md:items-end" : "md:items-start"}`} style={{ opacity: props.opacity }}>
...
export const Overlay = () => {
  ...
  const [sectionOpacityArr, setSectionOpacityArr] = useState([0, 0, 0, 0, 0, 0]);

  useFrame(() => {
    setLogoOpacity(scroll.range(0.98, 0.02));
    setScrollOpacity(1 - scroll.range(0, 0.03));
    setSectionOpacityArr([scroll.curve(0.1, 0.1), scroll.curve(0.24, 0.1), scroll.curve(0.39, 0.1), scroll.curve(0.54, 0.1), scroll.curve(0.68, 0.1), scroll.curve(0.82, 0.1)])
  })
