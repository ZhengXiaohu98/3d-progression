...
const CTA = dynamic(() => import("@/components/layout").then((mod) => mod.CTA));
const PageTip = dynamic(() => import("@/components/general").then((mod) => mod.PageTip));
...
const About: React.FC = () => {
  return (
    <>
      <div className="container sm:pt-28 md:pt-32 lg:pt-40 dark:text-accent-white text-accent-dark">
