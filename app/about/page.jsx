    ...
    <div className="container lg:max-w-[1092px] sm:w-full sm:pt-28 md:pt-32 lg:pt-40 dark:text-accent-white text-accent-dark">
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-8 tracking-wider lg:text-lg dark:text-accent-900 text-accent-300">
          ...
          <p>I graduated with a degree in Computer Science. To be honest, I wasn't initially sure what type of work I enjoyed. However, I discovered the joy of web development, especially with Next.js, which has made creating websites so much easier.</p>
        </div>
