        ...
        <Section right opacity={sectionOpacityArr[5]}>
          ...
          <ul className="mt-6 flex flex-col gap-2 dark:text-accent-white text-accent-300 text-lg">
            <li className="flex gap-2 items-center">
              <svg className="w-5 h-5 -mt-0.5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 462.799">
