    ...
    <Link href={data.url}>
      <div className={"rounded-xl dark:shadow-inner dark:shadow-white/[0.05] shadow-md shadow-black/[0.05] relative select-none group"}>
        ...
        <div className="rounded-lg relative overflow-hidden" >
          <Image src={data.img.src} width={data.img.width} height={data.img.height} className="w-[500px] h-[250px] group-hover:scale-105 rounded-xl transition relative z-[1]" alt={data.img.alt} priority/>
        </div>
