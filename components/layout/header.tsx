...
export const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      <header
        id="header"
        className="transition-all fixed container lg:max-w-[1060px] md:max-w-[680px] sm:max-w sm:top-3 md:top-4 lg:top-5 left-1/2 -translate-x-1/2 z-[50] bg-white/20 dark:bg-black/20 backdrop-blur-md sm:h-12 md:h-14 lg:h-16 flex items-center justify-between rounded-xl shadow-md shadow-black/10 dark:shadow-white/10"
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="sm:block md:hidden peer group overflow-hidden scale-125 mr-4 mt-px">
            <svg
              className="sm:block lg:hidden w-6 h-6 text-dark-base"
              aria-hidden="true"
