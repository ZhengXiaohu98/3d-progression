...
export const Header = () => {
  ...
  return (
    <header id="header" className="fixed container md:max-w-[1060px] sm:max-w top-5 left-1/2 -translate-x-1/2 z-[50] bg-white/20 dark:bg-black/20 backdrop-blur-md h-16 flex items-center justify-between rounded-xl shadow-md shadow-black/10 dark:shadow-white/10">
